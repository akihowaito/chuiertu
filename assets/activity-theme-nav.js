(function(){
  ...
  style.textContent=`
    ...
    @keyframes angelGlide{0%,100%{transform:translate3d(0,8px,0) rotate(-7deg);opacity:.18}45%{transform:translate3d(var(--drift),-14px,0) rotate(8deg);opacity:.55}}
    ...
    body[data-site-theme="angel"] .event-card,body[data-site-theme="angel"] .wheel-shell,body[data-site-theme="angel"] .inline-result,body[data-site-theme="angel"] .panel,body[data-site-theme="angel"] .history-card,body[data-site-theme="angel"] .probability-card,body[data-site-theme="angel"] .draw-card{border-color:rgba(242,168,204,.72)!important;box-shadow:0 8px 0 rgba(159,216,244,.18),0 20px 38px rgba(105,85,106,.08)!important}
    ...
    .activity-dock{position:fixed;left:18px;bottom:22px;z-index:70;display:flex;flex-direction:column;align-items:flex-start;gap:8px;font-family:"Huninn","PingFang SC","Microsoft YaHei",sans-serif}
    .activity-dock__panel{display:flex;flex-direction:column-reverse;align-items:flex-start;gap:8px}
    ...
    .activity-dock__link{padding:9px 13px}.activity-dock__toggle{display:none;padding:9px 12px;cursor:pointer}
    ...
    @media(max-width:760px){
      ...
      .activity-dock{left:12px;bottom:max(14px,env(safe-area-inset-bottom));gap:7px}.activity-dock__toggle{display:flex}
